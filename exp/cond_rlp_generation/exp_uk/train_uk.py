...
with open(os.path.join(_parent_path, 'exp/cond_rlp_generation/exp_uk/config_uk.yaml')) as file:
...
# train the model
path = os.path.join(_parent_path, 'exp/cond_rlp_generation/exp_uk')
