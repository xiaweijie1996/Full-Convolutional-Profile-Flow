...
with open(os.path.join(_parent_path, 'exp/prediction/usa/config_usa_pre.yaml')) as file:
...
# train the model
path = os.path.join(_parent_path, 'exp/prediction/usa')
tl.train_pre(path, model, dataloader_train, optimizer, 4000001, config['FCPflow']['condition_dim'], device, scaler, dataloader_test, scheduler, 100, False)
