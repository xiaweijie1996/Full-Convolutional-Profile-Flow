...
with open(os.path.join(_parent_path,'exp/data_requirement_ana/30_train_data/config_30_fcp.yaml')) as file:
...
# train the model
path = os.path.join(_parent_path, 'exp/data_requirement_ana/30_train_data')
