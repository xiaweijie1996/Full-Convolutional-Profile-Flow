...
with open(os.path.join(_parent_path,'exp/data_requirement_ana/100_train_data/config_100_fcp.yaml')) as file:
...
# train the model
path = os.path.join(_parent_path, 'exp/data_requirement_ana/')
