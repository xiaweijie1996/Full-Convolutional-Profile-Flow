...
with open(os.path.join(_parent_path,'exp/data_requirement_ana/10_train_data/config_10_fcp.yaml')) as file:
...
# train the model
path = os.path.join(_parent_path, 'exp/data_requirement_ana/10_train_data')
tl.train_data_ana(path, model, train_dataloader, optimizer, 500001, config['FCPflow']['condition_dim'], 
